...
from .operations import ServiceBindingsOperations
from . import models
...
class Microservices4SpringManagementClient(Microservices4SpringManagementClientOperationsMixin, SDKClient):
    ...
    :vartype artifacts: azure.mgmt.microservices4spring.operations.ArtifactsOperations
    ...
    :ivar service_bindings: ServiceBindings operations
    :vartype service_bindings: azure.mgmt.microservices4spring.operations.ServiceBindingsOperations
    ...
    def __init__(
        ...
        self.operations = Operations(
            self._client, self.config, self._serialize, self._deserialize)
        self.service_bindings = ServiceBindingsOperations(
            self._client, self.config, self._serialize, self._deserialize)
