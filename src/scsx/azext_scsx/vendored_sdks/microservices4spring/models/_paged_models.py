...
class ArtifactResourcePaged(Paged):
    """
    A paging container for iterating over a list of :class:`ArtifactResource <azure.mgmt.microservices4spring.models.ArtifactResource>` object
    """

    _attribute_map = {
        'next_link': {'key': 'nextLink', 'type': 'str'},
        'current_page': {'key': 'value', 'type': '[ArtifactResource]'}
    }

    def __init__(self, *args, **kwargs):

        super(ArtifactResourcePaged, self).__init__(*args, **kwargs)
...
class ServiceBindingResourcePaged(Paged):
    """
    A paging container for iterating over a list of :class:`ServiceBindingResource <azure.mgmt.microservices4spring.models.ServiceBindingResource>` object
    """

    _attribute_map = {
        'next_link': {'key': 'nextLink', 'type': 'str'},
        'current_page': {'key': 'value', 'type': '[ServiceBindingResource]'}
    }

    def __init__(self, *args, **kwargs):

        super(ServiceBindingResourcePaged, self).__init__(*args, **kwargs)
