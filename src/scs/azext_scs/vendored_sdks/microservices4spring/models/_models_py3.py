...
class AppResourceProperties(Model):
    ...
    :param name: Name of the resource. Internal property which only used when
     communicate with Lifecycle
    :type name: str
    """
    ...
    def __init__(self, *, public: bool=None, active_deployment_name: str=None, name: str=None, **kwargs) -> None:
...
class ArtifactInfo(Model):
    """Artifact info of Deployment resource.

    :param resource_type: Type of the artifact resource to be deployed.
     Possible values include: 'Jar', 'Source'
    :type resource_type: str or
     ~azure.mgmt.microservices4spring.models.ArtifactResourceType
    :param relative_path: Relative path of the storage which stores the
     artifact
    ...
    def __init__(self, *, resource_type=None, relative_path: str=None, **kwargs) -> None:
        super(ArtifactInfo, self).__init__(**kwargs)
...
class DeploymentResourceProperties(Model):
    ...
    :param artifact: Artifact name of the Deployment
    :type artifact: ~azure.mgmt.microservices4spring.models.ArtifactInfo
    ...
    _attribute_map = {
        ...
        'artifact': {'key': 'artifact', 'type': 'ArtifactInfo'},
        'provisioning_state': {'key': 'provisioningState', 'type': 'str'},
        'status': {'key': 'status', 'type': 'str'},
    ...
    def __init__(self, *, deployment_settings=None, artifact=None, name: str=None, **kwargs) -> None:
...
class ServiceBindingResourceProperties(Model):
    ...
    :ivar created_at: Creation time of the Service Binding resource
    :vartype created_at: str
    :ivar updated_at: Update time of the Service Binding resource
    ...
    def __init__(self, *, resource_name: str=None, resource_type: str=None, resource_id: str=None, key: str=None, binding_parameters=None, name: str=None, **kwargs) -> None:
